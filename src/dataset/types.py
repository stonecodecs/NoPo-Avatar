...
class BatchedViews(TypedDict, total=False):
    ...
    image_original: Float[Tensor, "batch _ _ _ _"]  # batch view channel height width - original images before inconsistent replacement
    image_inconsistent: Float[Tensor, "batch _ _ _ _"]  # batch view channel height width - inconsistent versions of images
...
class UnbatchedViews(TypedDict, total=False):
    ...
    image_original: Float[Tensor, "_ 3 height width"]  # original images before inconsistent replacement
    image_inconsistent: Float[Tensor, "_ 3 height width"]  # inconsistent versions of images
    near: Float[Tensor, " _"]
    far: Float[Tensor, " _"]
